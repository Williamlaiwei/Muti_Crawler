...
class AcademiaDownloader:
    ...
    async def download_paper_async(
        ...
        try:
            ...
            print(
                f"[ERROR] Download timeout: "
                f"{download_url}"
            )
            return False
        except Exception as e:
            print(
                f"[ERROR] Download exception: "
                f"{type(e).__name__}: {e}"
            )
            return False
                    ...
                    while True:
                        try:
                            ...
                            for work in works:
                                ...
                                print("KEYS:", list(work.keys()))
                                print(
                                    "downloadableAttachments:",
                                    work.get("downloadableAttachments")
                                )
                                ...
                                if attachments:
                                    for attachment in attachments:
                                        ...
                                        if download_url:
                                            ...
                                            if not success:
                                                print(
                                                    f"[WARN] Skipping failed download: "
                                                    f"{filename}"
                                                )
                                                continue
